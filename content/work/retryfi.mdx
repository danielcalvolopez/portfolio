...
<Fig n="1" caption="The recovery pipeline. Hard declines bypass the retry ladder; every box writes an auditable action row. Linework prints in the spot ink." src="/figs/retryfi-pipeline.svg" alt="Recovery pipeline diagram" w="690" h="160" />
